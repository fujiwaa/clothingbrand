...
<div class="container d-flex flex-column">
    <div class="sorting px-2 pt-4 order-2 order-lg-1">
    ...
    <div class="content py-5 order-1 order-lg-2">
        <div class="row">
            ...
            <div class="col-lg-3">
                <div class="card p-4 rounded-0">
                    <div class="card-body">
                        <ul class="list-group">
                            <li class="list-group-item"><a href="<?php echo $web_baseurl; ?>produk" class="text-decoration-none text-dongker fw-semibold">Semua Produk</a></li>
                    ...
                    <div class="card-body">
                        ...
                        <ul class="list-group text-uppercase mt-2">
                            ...
                            ?>
                                ...
                                <li class="list-group-item"><a href="<?php echo $web_baseurl; ?>produk/produk-kategori?category=<?php echo $data_category['name']; ?>" class="text-decoration-none <?php echo (strpos($_SERVER['REQUEST_URI'], $data_category['name']) == true) ? 'text-dongker fw-semibold' : 'text-secondary' ?>"><?php echo $data_category['name']; ?></a></li>
                            <?php } ?>
